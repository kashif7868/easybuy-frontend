...
import '../../assets/css/Easybuy/about.css';
    ...
    return (
        <div className="about-container">
            ...
            <div className="introduction-section">
                <h2>Welcome to <strong>Easy Buy</strong></h2>
                <p>
                    ...
                    of our Easy Buy family, and that philosophy drives every decision we make.
                </p>
            </div>
            ...
            <div className="info-sections">
                <div className="info-card">
                    ...
                    <h2>Our Mission</h2>
                    <p>
                        At Easy Buy, our mission is simple: to ensure the health, wealth, and happiness of every member of our extended family. 
                ...
                <div className="info-card">
                    ...
                    <p>
                        Easy Buy is built on trust, value, and the genuine belief that everyone deserves the best. We’re here to make sure you feel supported, 
            ...
            <div className="closing-section">
                <p>
                    Thank you for being a part of <strong>Easy Buy</strong>. Together, let’s build a future full of health, wealth, and happiness.
                </p>
            </div>
        </div>
    );
